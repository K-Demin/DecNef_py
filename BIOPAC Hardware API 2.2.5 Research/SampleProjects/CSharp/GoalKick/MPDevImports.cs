...
namespace Biopac.API.MPDevice
{
	...
	public class MPDevImports
	{
		...
		[DllImport(@"mpdev.dll")]
		public static extern MPRETURNCODE findAllMP200();		
		...
		[DllImport(@"mpdev.dll")]
		public static extern MPRETURNCODE readAvailableMP200SN(byte[] buff, uint numchartoread, out uint numcharread);
