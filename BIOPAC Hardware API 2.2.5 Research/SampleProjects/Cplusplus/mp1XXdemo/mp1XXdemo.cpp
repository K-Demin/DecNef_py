...
int main(int argc, char** argv)
{
	...
	//Note: Currently set to automatically discover the MP160.
	//Change the third parameter the serial number of the MP160
	//if it is not the BHAPI is not connecting to the correct MP160
	retval = connectMPDev(MP200, MPUDP, "auto");
